...
tool_schemas = [write_file_schema, read_file_schema, delete_file_schema, list_files_schema, read_skill_schema, get_current_datetime_schema, search_mcp_tools_schema, get_mcp_tool_details_schema, call_mcp_tool_schema]

TOOL_MAP = { "read_file": read_file,"write_file": write_file, "delete_file": delete_file, "list_files": list_files, "read_skill": read_skill, "get_current_datetime": get_current_datetime, "search_mcp_tools": search_mcp_tools, "get_mcp_tool_details": get_mcp_tool_details, "call_mcp_tool": call_mcp_tool}
